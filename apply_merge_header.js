...
const oldBlock = `    <div style="display:flex;align-items:center;padding:8px 10px;background:var(--surface);border-bottom:1px solid var(--border);gap:6px;flex-wrap:wrap;">
...
const newBlock = `    <div style="display:flex;align-items:center;padding:8px 10px;background:var(--surface);border-bottom:1px solid var(--border);gap:6px;flex-wrap:wrap;">
        <button onclick="movePair(-1)" style="background:none;border:none;font-size:20px;padding:8px;margin-right:8px;color:var(--txt)"><i class="fas fa-chevron-left"></i></button>
        <div class="chart-interval-selector" style="display:flex;gap:6px;align-items:center;">
            <button class="chart-interval-btn active" id="chartIntBtn1" data-interval="60" onclick="changeChartInterval('60', this)">1H</button>
            <button class="chart-interval-btn" id="chartIntBtn2" data-interval="240" onclick="changeChartInterval('240', this)">4H</button>
            <button class="chart-interval-btn" id="chartIntBtn3" data-interval="D" onclick="changeChartInterval('D', this)">1D</button>
        ...
        <button onclick="movePair(1)" style="background:none;border:none;font-size:20px;padding:8px;margin-left:8px;color:var(--txt)"><i class="fas fa-chevron-right"></i></button>
        <button onclick="openAlertDialog(document.getElementById('chartPairName').textContent)" style="background:none;border:none;font-size:20px;padding:8px;margin-left:4px;color:var(--gold);cursor:pointer;" title="Set Alert"><i class="fas fa-bell"></i></button>
        <button id="chartCloseBtn" onclick="closeChart()" style="background:none;border:none;font-size:20px;padding:8px;margin-left:4px;color:var(--red)"><i class="fas fa-times"></i></button>
    </div>`;
...
files.forEach(file => {
  ...
  if (content.includes(oldBlock)) {
    ...
    console.log(file + ': merged header updated OK');
  } else {
